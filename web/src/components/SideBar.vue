      ...
      <div class="space-y-4">
        ...
        <div class="space-y-1">
          <button
            ...
            aria-expanded="true" aria-controls="projects-dropdown">
            <div class="flex items-center">

<svg class="h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    <!-- Contorno del bolso --><path d="M4 8h16a1.5 1.5 0 0 1 1.5 1.5v8a1.5 1.5 0 0 1 -1.5 1.5H4a1.5 1.5 0 0 1 -1.5 -1.5v-8A1.5 1.5 0 0 1 4 8z" />
     <!-- Asa --><path d="M7 8c0-2 10-2 10 0" />
      <!-- Línea de separación superior --><path d="M4 10h16" />
       <!-- Cierre --><circle cx="12" cy="12.5" r="0.6" fill="white" /></svg>
Portafolio
</div>
<svg class="ml-2 h-5 w-5 transform transition-transform duration-200" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="space-y-1">
          ...
          <div class="space-y-1 pl-11" id="analytics-dropdown">
            ...
            <router-link :to="{ name: 'mediatypes' }"
              class="group flex items-center px-4 py-2 text-sm text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">
              Media Types
            </router-link>
            ...
            <router-link :to="{ name: 'inversiones-tiposactivos' }"
              class="group flex items-center px-4 py-2 text-sm text-gray-300 rounded-md hover:bg-gray-700 hover:text-white"
              active-class="bg-gray-800 text-white">
              Tipo de Activos
            </router-link>
