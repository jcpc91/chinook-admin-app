const EmployeeRepository = require('./jsonRepository/employee'); // Assuming employee.js is in jsonRepository
...
class EmployeeService {
  ...
  async createEmployee(employeeData) {
    ...
    if (!employeeData || !employeeData.FirstName || !employeeData.LastName) {
      throw new Error("FirstName and LastName are required to create an employee.");
    }
